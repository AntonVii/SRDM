...
MODEL_SPECS = [
    {"name": "c_B",  "stan_file": "SRDM_rr98_c_B.stan",  "init_fn": init_c_B,  "t0_varies": False},
    {"name": "c_t0", "stan_file": "SRDM_rr98_c_t0.stan", "init_fn": init_c_t0, "t0_varies": True},
    {"name": "d_B",  "stan_file": "SRDM_rr98_d_B.stan",  "init_fn": init_d_B,  "t0_varies": False},
    {"name": "d_t0", "stan_file": "SRDM_rr98_d_t0.stan", "init_fn": init_d_t0, "t0_varies": True},
]
    ...
    for attempt in range(5):
        try:
            spec["model"].sample(
                ...
                inits=spec["init_fn"](_warmup_data), show_progress=True, show_console=True,
            )
