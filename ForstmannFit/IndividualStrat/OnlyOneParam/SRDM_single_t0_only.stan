data {
  ...
  vector<lower=0>[3] t0_hi;   // t0 varies by condition - per-condition bound
}
...
model {
...

  {
    ...
    vector[N_correct] t0_trial_v = t0[cond_correct];
...

  {
    ...
    vector[N_false] t0_trial_v = t0[cond_false];
